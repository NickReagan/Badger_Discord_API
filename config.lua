Config = {
	...
	Guilds = {
		["Server-1"] = "guild_id", -- Replace this with a name, like "main"
	},
	Bot_Token = 'MTAyNzc3MjA0Mjk5ODcyNjY4Ng.GbdAJl.bjYF6p3nd1VaEBVlchG-Sn0TU1dgio_DuYkC3Q',
	RoleList = {
	...
	CacheDiscordRolesTime = 120, -- if CacheDiscordRoles is true, how long to cache roles before clearing (in seconds)
}
